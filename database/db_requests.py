...
class Paginator:
    ...
    def get_previous(self):
        ...
        raise IndexError(f'Предыдущей страницы не существует. ')
...
Добавление, изменение, удаление товаров для администратора
...
Работа запросов к бд с корзинами
